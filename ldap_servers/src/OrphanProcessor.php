...
class OrphanProcessor {
  ...
  public function checkOrphans() {
    ...
    if (!$this->ldapUserConf->orphanedDrupalAcctBehavior ||
      $this->ldapUserConf->orphanedDrupalAcctBehavior == 'ldap_user_orphan_do_not_check') {
      return TRUE;
    }
    ...
    //   ->range(0, $this->ldapUserConf->orphanedCheckQty - 1)
    ...
    if ($user_count < $this->ldapUserConf->orphanedCheckQty) {

 ...
 *   'convert' => 1 | 0 convert from binary to string for storage and comparison
 *     purposes
 *   'direction' => LdapUserAttributesInterface::PROVISION_TO_DRUPAL or
 *   LdapUserAttributesInterface::PROVISION_TO_LDAP leave empty if configurable
 ...
 *   'property' (user property such as mail, picture, timezone that is not a
 *   field)
 *   'field' (any field attached to the user such as field_user_lname)
 *   'profile2' (profile2 fields)
 *   'data' ($user->data array.  field_name will be used as key such as
 *      $user->data[<field_name>] = mapped value
 * 'field_name' machine name of property, field, profile2 field, or data
